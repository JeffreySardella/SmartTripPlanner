# SmartTripPlanner Implementation Plan
...
**Files:**
- Create: `SmartTripPlanner.sln`
- Create: `src/SmartTripPlanner.Api/SmartTripPlanner.Api.csproj`
- Create: `src/SmartTripPlanner.Api/Program.cs`
- Create: `src/SmartTripPlanner.Tests/SmartTripPlanner.Tests.csproj`
- Create: `.gitignore`
...
dotnet new sln -n SmartTripPlanner
dotnet new webapi -n SmartTripPlanner.Api -o src/SmartTripPlanner.Api --framework net8.0 --no-openapi
dotnet sln SmartTripPlanner.sln add src/SmartTripPlanner.Api/SmartTripPlanner.Api.csproj
```

**Step 2: Create test project**

```bash
dotnet new xunit -n SmartTripPlanner.Tests -o src/SmartTripPlanner.Tests --framework net8.0
dotnet sln SmartTripPlanner.sln add src/SmartTripPlanner.Tests/SmartTripPlanner.Tests.csproj
dotnet add src/SmartTripPlanner.Tests/SmartTripPlanner.Tests.csproj reference src/SmartTripPlanner.Api/SmartTripPlanner.Api.csproj
```
...
```bash
# API project
dotnet add src/SmartTripPlanner.Api package Google.Apis.Calendar.v3
dotnet add src/SmartTripPlanner.Api package Microsoft.EntityFrameworkCore.Sqlite
dotnet add src/SmartTripPlanner.Api package Microsoft.EntityFrameworkCore.Design
dotnet add src/SmartTripPlanner.Api package Serilog.AspNetCore

# Test project
dotnet add src/SmartTripPlanner.Tests package Microsoft.EntityFrameworkCore.InMemory
dotnet add src/SmartTripPlanner.Tests package NSubstitute
```
...
```bash
git add SmartTripPlanner.sln src/ .gitignore
...
**Files:**
- Create: `src/SmartTripPlanner.Api/Models/Trip.cs`
- Create: `src/SmartTripPlanner.Api/Models/TripEvent.cs`
- Create: `src/SmartTripPlanner.Api/Models/CachedLocation.cs`
- Create: `src/SmartTripPlanner.Api/Models/UserPreference.cs`
- Create: `src/SmartTripPlanner.Api/Models/FreeBusyBlock.cs`
- Create: `src/SmartTripPlanner.Api/Models/TravelValidation.cs`

**Step 1: Create entity models**

```csharp
// src/SmartTripPlanner.Api/Models/Trip.cs
...
```csharp
// src/SmartTripPlanner.Api/Models/TripEvent.cs
namespace SmartTripPlanner.Api.Models;
...
```csharp
// src/SmartTripPlanner.Api/Models/CachedLocation.cs
namespace SmartTripPlanner.Api.Models;
...
```csharp
// src/SmartTripPlanner.Api/Models/UserPreference.cs
namespace SmartTripPlanner.Api.Models;
...
```csharp
// src/SmartTripPlanner.Api/Models/FreeBusyBlock.cs
namespace SmartTripPlanner.Api.Models;
...
```csharp
// src/SmartTripPlanner.Api/Models/TravelValidation.cs
namespace SmartTripPlanner.Api.Models;
...
```bash
git add src/SmartTripPlanner.Api/Models/
...
**Files:**
- Create: `src/SmartTripPlanner.Api/Data/SmartTripPlannerDbContext.cs`
- Modify: `src/SmartTripPlanner.Api/Program.cs`

**Step 1: Create DbContext**

```csharp
// src/SmartTripPlanner.Api/Data/SmartTripPlannerDbContext.cs
...
```bash
dotnet ef migrations add InitialCreate --project src/SmartTripPlanner.Api
```
...
```bash
git add src/SmartTripPlanner.Api/Data/ src/SmartTripPlanner.Api/Program.cs src/SmartTripPlanner.Api/Migrations/ src/SmartTripPlanner.Api/appsettings.json
...
**Files:**
- Create: `src/SmartTripPlanner.Api/Services/ITravelService.cs`
- Create: `src/SmartTripPlanner.Api/Services/TravelService.cs`
- Create: `src/SmartTripPlanner.Tests/Services/TravelServiceTests.cs`

**Step 1: Write the failing tests**

```csharp
// src/SmartTripPlanner.Tests/Services/TravelServiceTests.cs
...
```bash
dotnet test src/SmartTripPlanner.Tests --filter "FullyQualifiedName~TravelServiceTests" -v minimal
```
...
```csharp
// src/SmartTripPlanner.Api/Services/ITravelService.cs
...
```csharp
// src/SmartTripPlanner.Api/Services/TravelService.cs
namespace SmartTripPlanner.Api.Services;
...
```bash
git add src/SmartTripPlanner.Api/Services/ITravelService.cs src/SmartTripPlanner.Api/Services/TravelService.cs src/SmartTripPlanner.Tests/Services/ src/SmartTripPlanner.Api/Program.cs
...
**Files:**
- Create: `src/SmartTripPlanner.Api/Services/ICalendarService.cs`
- Create: `src/SmartTripPlanner.Api/Services/CalendarService.cs`
- Create: `src/SmartTripPlanner.Tests/Services/CalendarServiceTests.cs`

**Step 1: Write the failing tests (with mocked Google Calendar)**

```csharp
// src/SmartTripPlanner.Tests/Services/CalendarServiceTests.cs
namespace SmartTripPlanner.Tests.Services;
...
```bash
dotnet test src/SmartTripPlanner.Tests --filter "FullyQualifiedName~CalendarServiceTests" -v minimal
```
...
```csharp
// src/SmartTripPlanner.Api/Services/ICalendarService.cs
namespace SmartTripPlanner.Api.Services;
...
```csharp
// src/SmartTripPlanner.Api/Services/CalendarService.cs
namespace SmartTripPlanner.Api.Services;
...
```bash
git add src/SmartTripPlanner.Api/Services/ICalendarService.cs src/SmartTripPlanner.Api/Services/CalendarService.cs src/SmartTripPlanner.Tests/Services/CalendarServiceTests.cs
...
**Files:**
- Create: `src/SmartTripPlanner.Api/Services/IOllamaClient.cs`
- Create: `src/SmartTripPlanner.Api/Services/OllamaClient.cs`
- Create: `src/SmartTripPlanner.Api/Models/OllamaModels.cs`
- Create: `src/SmartTripPlanner.Tests/Services/OllamaClientTests.cs`

**Step 1: Create Ollama request/response models**

```csharp
// src/SmartTripPlanner.Api/Models/OllamaModels.cs
namespace SmartTripPlanner.Api.Models;
...
```bash
dotnet test src/SmartTripPlanner.Tests --filter "FullyQualifiedName~OllamaClientTests" -v minimal
```
...
```csharp
// src/SmartTripPlanner.Api/Services/IOllamaClient.cs
namespace SmartTripPlanner.Api.Services;
...
```bash
git add src/SmartTripPlanner.Api/Models/OllamaModels.cs src/SmartTripPlanner.Api/Services/IOllamaClient.cs src/SmartTripPlanner.Api/Services/OllamaClient.cs src/SmartTripPlanner.Tests/Services/OllamaClientTests.cs src/SmartTripPlanner.Api/Program.cs src/SmartTripPlanner.Api/appsettings.json
...
**Files:**
- Create: `src/SmartTripPlanner.Api/Tools/ToolDefinitions.cs`
- Create: `src/SmartTripPlanner.Tests/Tools/ToolDefinitionsTests.cs`
...
```bash
dotnet test src/SmartTripPlanner.Tests --filter "FullyQualifiedName~ToolDefinitionsTests" -v minimal
```
...
```bash
git add src/SmartTripPlanner.Api/Tools/ src/SmartTripPlanner.Tests/Tools/
...
**Files:**
- Create: `src/SmartTripPlanner.Api/Services/IAgentService.cs`
- Create: `src/SmartTripPlanner.Api/Services/AgentService.cs`
- Create: `src/SmartTripPlanner.Tests/Services/AgentServiceTests.cs`
...
```bash
dotnet test src/SmartTripPlanner.Tests --filter "FullyQualifiedName~AgentServiceTests" -v minimal
```
...
```csharp
// src/SmartTripPlanner.Api/Services/IAgentService.cs
namespace SmartTripPlanner.Api.Services;
...
```bash
git add src/SmartTripPlanner.Api/Services/IAgentService.cs src/SmartTripPlanner.Api/Services/AgentService.cs src/SmartTripPlanner.Tests/Services/AgentServiceTests.cs src/SmartTripPlanner.Api/Program.cs
...
**Files:**
- Create: `src/SmartTripPlanner.Api/Controllers/TripController.cs`
...
```bash
git add src/SmartTripPlanner.Api/Controllers/
